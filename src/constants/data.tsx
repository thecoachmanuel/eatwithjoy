const faqData = [
  ...
  },
  {
    ...
    answer:
      "Minimum order amount depends on the restaurant and is usually ₦5,000 - ₦10,000. The exact amount is shown on each restaurant's page.",
  },
  {
    id: 7,
...
const onboarding = [
  ...
  {
    id: 2,
    image: 'https://george-fx.github.io/yummer-data/onboarding/02.png',
    title: 'Choose favorite dishes!',
    description:
      'Select delicious meals from our menu and add them to your cart easily.',
  },
  {
    id: 3,
    image: 'https://george-fx.github.io/yummer-data/onboarding/03.png',
    title: 'Get your food delivery!',
    description:
      'Sit back and relax while we deliver hot food straight to your door.',
  },
];

export const data = {faqData, onboarding};
